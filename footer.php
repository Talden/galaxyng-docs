...
<p><?php if ($_SERVER['PHP_SELF'] == "/index.php") { ?>GalaxyNG 6.4<?php } else { ?><a href="/">GalaxyNG 6.6</a><?php } ?> | <?php if ($_SERVER['PHP_SELF'] == "/credits.php") { ?>Credits and License<?php } else { ?><a href="/credits.php">Credits and License</a><?php } ?></p>
<p><?php echo $title; ?>
