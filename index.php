...
<!-- $Id$ -->
	...
	<body>
		...
		<h1><img src="galaxyng.png" alt="GalaxyNG" /></h1>
			...
			<h2>Introduction</h2>
				<p>Galaxy is a free play by email interstellar wargame for multiple players.  The object of the game is to conquer the galaxy by colonizing and developing uninhabited planets and attacking neighboring races.  GalaxyNG is a <a href="variants.php">variant</a> of Galaxy <a href="whyng.php">created by Frans Slothouber</a> which introduced multiple homeworlds and partial bombings.  It is the variant that is most similar to original Galaxy.</p>
